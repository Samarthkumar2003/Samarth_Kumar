...
Original file is located at
    https://colab.research.google.com/drive/16V6_IQhuk81Z3BV6iYTsTTgUVByhYVxk
"""
...
projection_data['Date'] = projection_data['Date'].dt.date

# Create the table
table_fig = go.Figure(data=[go.Table(
    header=dict(values=["Date", "Predicted Value"]),
    cells=dict(values=[projection_data['Date'], projection_data['Predicted Value']])
)])
...
# Assuming you have x_projection_Arbitrum containing close prices,
# linReg_prediction_Arbitrum containing predicted values,
# and projection_dates containing corresponding dates.

# Example: Generating sample projection dates
projection_dates = pd.date_range(start='2024-04-17', periods=len(x_projection_Arbitrum), freq='D')
...
# Assuming you have x_projection_Chainlink containing close prices,
# linReg_prediction_Chainlink containing predicted values,
# and projection_dates containing corresponding dates.

# Example: Generating sample projection dates
projection_dates = pd.date_range(start='2024-04-17', periods=len(x_projection_Chainlink), freq='D')
